...
function nazar_load_main_scripts()
{
    ...
    wp_enqueue_style('nazar_general', get_template_directory_uri().'/css/nazar.css', array('jquery'), '0.1', 'all');
}
...
function nazar_load_admin_scripts()
{
    ...
    wp_enqueue_script('nazar_admin_js', get_template_directory_uri().'/js/nazar.admin.js', array('jquery'), '0.1', true);
    wp_enqueue_media();
}
